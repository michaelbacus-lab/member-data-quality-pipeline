...
SRC_FEE = "/mnt/user-data/uploads/membership_feexlsx.csv"
SRC_CUST = "/mnt/user-data/outputs/customers_info_cleaned.csv"  # already cleaned earlier in this session
OUT_CSV = "/mnt/user-data/outputs/membership_fee_cleaned.csv"
OUT_XLSX = "/mnt/user-data/outputs/membership_fee_aggregated.xlsx"
OUT_REPORT = "/mnt/user-data/outputs/membership_fee_cleaning_report.txt"
