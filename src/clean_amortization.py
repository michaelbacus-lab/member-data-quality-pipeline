...
SRC = "/mnt/user-data/uploads/amortization.csv"
OUT_CSV = "/mnt/user-data/outputs/amortization_cleaned.csv"
OUT_XLSX = "/mnt/user-data/outputs/amortization_aggregated.xlsx"
OUT_REPORT = "/mnt/user-data/outputs/amortization_cleaning_report.txt"
